...
INSERT INTO Animal (Name, Type, Breed, DateOfBirth, Id_Enclosure, CurrentStatus, Gender, Size, Temperament) VALUES
('Рекс', 'Собака', 'Немецкая овчарка', '2020-05-10', 1, 'Доступен', 'Самец', 'Крупный', 'Дружелюбный, активный, хорошо обучаем'),
('Мурка', 'Кошка', 'Британская', '2021-03-15', 2, 'Доступен', 'Самка', 'Средний', 'Спокойная, ласковая, любит детей'),
('Шарик', 'Собака', 'Дворняга', '2019-08-20', 1, 'Доступен', 'Самец', 'Средний', 'Игривый, добрый, преданный'),
('Барсик', 'Кошка', 'Сиамская', '2022-01-05', 2, 'Доступен', 'Самец', 'Средний', 'Независимый, умный, разговорчивый'),
('Белка', 'Собака', 'Лабрадор', '2021-07-12', 3, 'Доступен', 'Самка', 'Крупный', 'Энергичная, любит играть, дружелюбная'),
('Тузик', 'Собака', 'Хаски', '2020-11-20', 1, 'Доступен', 'Самец', 'Крупный', 'Активный, общительный, любит бегать'),
('Муся', 'Кошка', 'Персидская', '2021-06-10', 2, 'Доступен', 'Самка', 'Средний', 'Спокойная, ленивая, любит ласку'),
('Бим', 'Собака', 'Джек-рассел-терьер', '2022-02-14', 3, 'Доступен', 'Самец', 'Маленький', 'Энергичный, умный, игривый');
...
('user1', '$2a$11$7oKJ8hP5N0Y4UQzXJh4Hf.LZWpLJCc2qYxH8sK6rP9mN4vT2wE8yO', 'user1@example.com', 'Иванов Иван', 'User', 1);
